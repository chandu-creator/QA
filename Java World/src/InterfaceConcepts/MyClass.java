...
// If you comment below two methods, you can see a compilation error
	/*
	 * This class is just implementing MyInterfaceTwo but it has to implement all
	 * the methods of MyInterfaceTwo and MyInterfaceOne as well because
	 * MyInterfaceTwo extends MyInterfaceOne
	 */
